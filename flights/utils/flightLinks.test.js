...
test( "should generate array of consecutive a date and given a number of days", () => {
    const expectedResult = ["2017-04-14", "2017-04-15", "2017-04-16", "2017-04-17", "2017-04-18"]
    expect( flightLinks.datesFromTo( 5, "2017-04-14" ) ).toEqual( expectedResult )
})

test( "should generate all possible date links for a single destination", () => {
    const dates = [ "2017-10-29", "2017-10-30", "2017-11-01", "2017-11-02" ]
    const expectedResult = [{"depDate": "2017-10-29", "from": "EDI", "path": "https://www.google.co.uk/flights/#search;f=EDI;t=MAD;d=2017-10-29;r=2017-10-30", "retDate": "2017-10-30", "to": "MAD"}, {"depDate": "2017-10-30", "from": "EDI", "path": "https://www.google.co.uk/flights/#search;f=EDI;t=MAD;d=2017-10-30;r=2017-10-31", "retDate": "2017-10-31", "to": "MAD"}, {"depDate": "2017-11-01", "from": "EDI", "path": "https://www.google.co.uk/flights/#search;f=EDI;t=MAD;d=2017-11-01;r=2017-11-02", "retDate": "2017-11-02", "to": "MAD"}, {"depDate": "2017-11-02", "from": "EDI", "path": "https://www.google.co.uk/flights/#search;f=EDI;t=MAD;d=2017-11-02;r=2017-11-03", "retDate": "2017-11-03", "to": "MAD"}]
    expect( flightLinks.createLinks( "MAD", dates, 2 ) ).toEqual( expectedResult )
})
